...
public class TeamMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seeTasksButton = findViewById(R.id.seeTasksButton);
            ...
            public void onChanged(UserProfile userProfile) {
                if (!userProfile.equals(UserProfile.NULL_PROFILE)) {
                    ...
                    if (userProfile.getRole().equals("lead")) {
                        seeTasksButton.setText("Manage Team");
                    }
                }
            }
        });
        ...
        seeTasksButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
